var bow , flecha,  background, redB, pinkB, greenB ,blueB ,arrowGroup;
...
function draw() {
 background(0);
  ...
  if (flechaGroup.isTouching(redB)) {
  ...
  if (flechaGroup.isTouching(greenB)) {
    greenB.destroyEach();
    flechaGroup.destroyEach();
    score=score+3;
  }

  if (flechaGroup.isTouching(blueB)) {
    blueB.destroyEach();
    flechaGroup.destroyEach();
    score=score+2;
  }

  if (flechaGroup.isTouching(pinkB)) {
    pinkB.destroyEach();
    flechaGroup.destroyEach();
    score=score+1;
  }
